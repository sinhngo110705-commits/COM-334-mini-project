INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_dinh_duong_1', 'Sữa Hạt – "Vàng Trắng" Của Thế Kỷ XXI Trong Dinh Dưỡng Hiện Đại', 'Dinh Dưỡng', '<div class="blog-article">
  <img src="/cdn/products/blog_dinh_duong_1.png" alt="Sữa Hạt và các nguyên liệu tự nhiên" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
...
INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_dinh_duong_2', 'Hạnh Nhân vs Hạt Điều: Chọn Loại Sữa Hạt Nào Phù Hợp Nhất Với Bạn?', 'Dinh Dưỡng', '<div class="blog-article">
  <img src="/cdn/products/blog_dinh_duong_2.png" alt="Sữa hạnh nhân thuần tự nhiên" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
...
INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_cong_thuc_1', 'Công Thức Làm Sữa Hạt Điều Tại Nhà Chỉ Trong 15 Phút – Ngon Hơn Mua Ngoài', 'Công Thức', '<div class="blog-article">
  <img src="/cdn/products/blog_cong_thuc_1.png" alt="Quy trình làm sữa hạt tại nhà" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
...
INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_cong_thuc_2', 'Smoothie Bowl Sữa Hạt 5 Màu – Bữa Sáng Vừa Đẹp Vừa Dinh Dưỡng Trong 10 Phút', 'Công Thức', '<div class="blog-article">
  <img src="/cdn/products/blog_cong_thuc_2.png" alt="Smoothie Bowl màu sắc với sữa hạt" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
...
INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_fitness_1', 'Sữa Hạt Và Thể Hình: Bí Kíp Phục Hồi Sau Tập Luyện Của Các Vận Động Viên', 'Fitness', '<div class="blog-article">
  <img src="/cdn/products/blog_fitness_1.png" alt="Vận động viên uống sữa hạt sau tập gym" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
...
INSERT OR REPLACE INTO blogs (id, title, category, content, image_url, is_active, created_at) VALUES ('blg_gia_dinh_1', 'Sữa Hạt Cho Cả Gia Đình: Từ Em Bé Đến Ông Bà – Ai Cũng Uống Được!', 'Gia Đình', '<div class="blog-article">
  <img src="/cdn/products/blog_gia_dinh_1.png" alt="Gia đình hạnh phúc dùng bữa sáng cùng sữa hạt" style="width:100%;border-radius:16px;margin-bottom:32px;object-fit:cover;max-height:400px" />
